...
void loop()
{
    ...
    {
      HTTPClient http;
      int val0 = analogReadMilliVolts(A0);
      int val1 = analogReadMilliVolts(A1);
      int val2 = analogReadMilliVolts(A2);
      int val3 = analogReadMilliVolts(A3);
      ...
      json["sidePressureL"] = val2;
      json["sidePressureR"] = val1;
